                            ...
                            (Return
                             (FunctionCall
                              ((ResolvedReference (serialize_int <opaque>))
                               ...
                               false))))))))
                       ((StructField
                         ((Reference (self (StructType 124))) a (StructType 41)))
                        (Reference (b (StructType 3))))
                       false)))))
                  (Let
                   ((b
                            ...
                            (Return
                             (FunctionCall
                              ((ResolvedReference (serialize_int <opaque>))
                               ...
                               false))))))))
                       ((StructField
                         ((Reference (self (StructType 124))) b (StructType 121)))
                        (Reference (b (StructType 3))))
                       false)))))
                  (Return (Reference (b (StructType 3))))))))))))
          (T (Value (Type (StructType 124))))))
        (structs
         ((124
           ((struct_fields
             ((a ((field_type (StructType 41))))
              (b ((field_type (StructType 121))))))
            (struct_details
                      ...
                      (FunctionCall
                       ((Value
                         (Function
                          ((function_signature
                            ((function_params
                              ((v (UnionType 122)) (s (StructType 7))))
                             (function_returns (StructType 125))))
                           (function_impl
                            (Fn
                             (Return
         ...
         ((struct_fields
          ...
          (struct_details
           ((uty_methods
             ((new
               ((function_signature
                 ((function_params ((v (UnionType 122)) (s (StructType 7))))
                  (function_returns (StructType 125))))
                (function_impl
                 (Fn
                  (Return
                ...
                ((from
                  ((function_signature
                   ...
                   (function_impl
                    (Fn
                     (Return
                      (MakeUnionVariant ((Reference (v (StructType 33))) 122))))))))))
              ((impl_interface 124)
               (impl_methods
                ((from
                  ((function_signature
                   ...
                   (function_impl
                    (Fn
                     (Return
                      (MakeUnionVariant ((Reference (v (StructType 22))) 122))))))))))))
            (uty_id 122) (uty_base_id 121)))))))
      (interfaces
       ((124
         ((interface_methods
