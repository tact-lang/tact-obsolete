                             ...
                             (FunctionCall
                              ((ResolvedReference (serialize_int <opaque>))
                               ((Reference (builder (StructType 3)))
                                ...
                                (Value (Integer 32)))))))))))
                       ((StructField
                         ((Reference (self (StructType 89))) a (StructType 84)))
                        (Reference (b (StructType 3)))))))))
                  (Let
                   ((b
                     (FunctionCall
                            ...
                            (Return
                             (FunctionCall
                              ((ResolvedReference (serialize_int <opaque>))
                               ((Reference (builder (StructType 3)))
                                (StructField
                                 ((Reference (self (StructType 86))) value
                                  IntegerType))
                                (Value (Integer 16)))))))))))
                       ((StructField
                         ((Reference (self (StructType 89))) b (StructType 86)))
                        (Reference (b (StructType 3)))))))))
                  (Return (Reference (b (StructType 3))))))))))))
          (T (Value (Type (StructType 89))))))
        (structs
         ((89
           ((struct_fields
             ((a ((field_type (StructType 84))))
              (b ((field_type (StructType 86))))))
            (struct_details
         ...
         (1
          (((st_sig_fields
             ((a (Value (Type (StructType 84))))
              (b (Value (Type (StructType 86))))))
            (st_sig_methods ()) (st_sig_base_id 88) (st_sig_id 88)))))
        (union_signs (0 ())))) |}]
    ...
    (Ok
     ((bindings
      ...
      (struct_signs
       (1
        (((st_sig_fields
           ((value1 (Value (Type (StructType 14))))
            (value2 (Value (Type (StructType 27))))))
