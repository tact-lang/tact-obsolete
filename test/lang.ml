      ...
      (struct_signs
       (1
        (((st_sig_fields ((t (Value (Type (StructType 121))))))
          (st_sig_methods ()) (st_sig_base_id 123) (st_sig_id 51)))))
      (union_signs (0 ())) (attr_executors <opaque>))) |}]
    ...
    (((DuplicateField
       (a
        ((mk_struct_fields
         ...
         (mk_struct_details
          ((mk_methods ()) (mk_impls ()) (mk_id 123) (mk_sig 51)
           (mk_span <opaque>)))))))
     ((bindings ((MyType (Value (Type (StructType 124))))))
      (structs
       ((124
      ...
      (struct_signs
       (1
        (((st_sig_fields ((a (Reference (A (TypeN 0)))))) (st_sig_methods ())
          (st_sig_base_id 121) (st_sig_id 51)))))
      (union_signs (0 ())) (attr_executors <opaque>))) |}]
     ...
     ((bindings
       ((serialize_outer
         (Value
          (Function
           ((function_signature
             ((function_params ((self (StructType 124)) (b (StructType 3))))
              (function_returns (StructType 3))))
            (function_impl
             (Fn
              (Block
                          ...
                          (Return
                           (FunctionCall
                            ((ResolvedReference (serialize_int <opaque>))
                             ...
                             false))))))))
                     ((StructField
                       ((Reference (self (StructType 124))) y (StructType 41)))
                      (Reference (b (StructType 3))))
                     false)))))
                (Return (Reference (b (StructType 3))))))))))))
        (Outer (Value (Type (StructType 124))))
        (Inner (Value (Type (StructType 122))))))
      (structs
       ((124
         ((struct_fields
           ((y ((field_type (StructType 41))))
            (z ((field_type (StructType 122))))))
          (struct_details
           ((uty_methods ()) (uty_impls ()) (uty_id 124) (uty_base_id 123)))))
        (122
      ...
      (struct_signs
       (2
        (((st_sig_fields
          ...
          (st_sig_methods ()) (st_sig_base_id 123) (st_sig_id 52))
         ...
         (Value
          (UnionVariant
           ((Struct
            ...
            122))))
        (a (Value (UnionVariant ((Integer 10) 122))))
        (test
         (Value
          (Function
           ((function_signature
             ((function_params ((value (UnionType 122))))
              (function_returns (UnionType 122))))
            (function_impl (Fn (Return (Reference (value (UnionType 122))))))))))
        (Uni (Value (Type (UnionType 122))))))
      (structs ())
      (unions
       ((122
         ((union_attributes ())
  ...
  [%expect
    ...
    (Ok
     ((bindings ((Test (Value (Type (UnionType 126))))))
      ...
      (union_signs
       (1
        (((un_sig_cases ((StructType 121) (StructType 123)))
          (un_sig_methods
           ((id
             ((function_params
               ((self (ExprType (Reference (Self (UnionSig 5)))))))
                       ...
                       ((function_signature
                        ...
                        (function_impl
                         (Fn
                          (Return
                           (Reference (x (ExprType (Reference (X (TypeN 0))))))))))))))
                   (mk_impls ()) (mk_id 121) (mk_sig 51) (mk_span <opaque>))))))))))))))
      (structs
       ((125
         ((struct_fields ())
          (struct_details
     ...
     ((bindings
       ((must_be_64 (Value (Integer 64))) (must_be_32 (Value (Integer 32)))
        (test
         (Value
          (Function
           ((function_signature
             ((function_params ((i (UnionType 124))))
              (function_returns IntegerType)))
            (function_impl
             (Fn
              (Switch
               ((switch_condition (Reference (i (UnionType 124))))
                (branches
      ...
      (unions
       ((124
         ((union_attributes ())
          (cases
           (((StructType 121) (Discriminator 1))
                ...
                ((from
                  ((function_signature
                   ...
                   (function_impl
                    (Fn
                     (Return
                      (MakeUnionVariant ((Reference (v (StructType 41))) 124))))))))))
              ((impl_interface 126)
               (impl_methods
                ((from
                  ((function_signature
                  ...
                  (Function
                   ((function_signature
                     ((function_params ((self (StructType 123))))
                      (function_returns IntegerType)))
                    (function_impl (Fn (Return (Value (Integer 1))))))))
                 ((Reference (t (StructType 123)))) false)))))))))
        (test
         (Value
          (Function
           ((function_signature
                  ...
                  (Fn
                   (Return
                    (IntfMethodCall
                     ((intf_instance
                       (Value
                        (Type (ExprType (Reference (T (InterfaceType 121)))))))
                      (intf_def 121)
                      (intf_method
                       (beep
...
let%expect_test "type that does not implement interface passed to the \
  ...
  [%expect
    {|
    (((TypeError ((InterfaceType 121) (Type0 (StructType 123)) <opaque>))
      (ArgumentNumberMismatch (1 1 <opaque>)))
     ((bindings
       ((Foo (Value (Type (StructType 123))))
        (ExpectedIntf
         (Value
          (Function
           ((function_signature
              ...
              (Return
               (MkStructDef
                ((mk_struct_attributes
                 ...
                 (mk_struct_fields ())
                 (mk_struct_details
                  ((mk_methods ()) (mk_impls ()) (mk_id 123) (mk_sig 52)
                   (mk_span <opaque>))))))))))))
        (T (Value (Type (StructType 122))))))
      (structs
       ((133
