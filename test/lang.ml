  ...
  [%expect
    ...
    (Ok
     ((bindings ((T (Value (Type (StructType 87))))))
      ...
      (struct_signs
       (1
        (((st_sig_fields ((t (Value (Type (StructType 84))))))
          (st_sig_methods ()) (st_sig_base_id 86) (st_sig_id 88)))))
      (union_signs (0 ())))) |}]
      ...
      (struct_signs
       (1
        (((st_sig_fields ((a (Reference (A (TypeN 0)))))) (st_sig_methods ())
          (st_sig_base_id 84) (st_sig_id 88)))))
      (union_signs (0 ())))) |}]
        ...
        (((st_sig_fields ())
          (st_sig_methods
           ((bar
             ((function_params
               ((self (ExprType (Reference (Self (StructSig 88)))))))
              (function_returns (ExprType (Reference (Self (StructSig 88)))))))))
          (st_sig_base_id 84) (st_sig_id 88)))))
      (union_signs (0 ())))) |}]
  ...
  [%expect
    ...
    (Ok
     ((bindings
      ...
      (type_counter <opaque>) (memoized_fcalls <opaque>) (struct_signs (0 ()))
      (union_signs
       (1 (((un_sig_cases (BoolType)) (un_sig_methods ()) (un_sig_base_id 84))))))) |}]
      ...
      (struct_signs
       (1
        (((st_sig_fields
          ...
          (st_sig_methods ()) (st_sig_base_id 84) (st_sig_id 88)))))
      (union_signs (0 ())))) |}]
...
let%expect_test "type check error" =
  ...
  [%expect
    {|
    (((TypeError ((StructType 86) (StructType 84))))
     ((bindings
       ((foo
         (Value
          (Function
        ...
        (((st_sig_fields ())
          (st_sig_methods
           ((new
             ((function_params ())
              (function_returns (ExprType (Reference (Self (StructSig 88)))))))))
          (st_sig_base_id 85) (st_sig_id 88)))))
      (union_signs (0 ())))) |}]
     ...
     ((bindings
       ((serialize_outer
         (Value
          (Function
           ((function_signature
             ((function_params ((self (StructType 89)) (b (StructType 3))))
              (function_returns (StructType 3))))
            (function_impl
             (Fn
              (Block
                           ...
                           (FunctionCall
                            ((ResolvedReference (serialize_int <opaque>))
                             ((Reference (builder (StructType 3)))
                              ...
                              (Value (Integer 32)))))))))))
                     ((StructField
                       ((Reference (self (StructType 89))) y (StructType 84)))
                      (Reference (b (StructType 3)))))))))
                (Return (Reference (b (StructType 3))))))))))))
        (Outer (Value (Type (StructType 89))))
        (Inner (Value (Type (StructType 87))))))
      (structs
       ((89
         ((struct_fields
           ((y ((field_type (StructType 84))))
            (z ((field_type (StructType 87))))))
          (struct_details
           ((uty_methods ()) (uty_impls ()) (uty_id 89) (uty_base_id 88)))))
        (87
         ((struct_fields ((x ((field_type (StructType 84))))))
          (struct_details
           ((uty_methods ()) (uty_impls ()) (uty_id 87) (uty_base_id 86)))))
        (85
         ((struct_fields
      ...
      (struct_signs
       (2
        (((st_sig_fields
           ((y (Value (Type (StructType 84))))
            (z (ResolvedReference (Inner <opaque>)))))
          (st_sig_methods ()) (st_sig_base_id 88) (st_sig_id 89))
         ((st_sig_fields ((x (Value (Type (StructType 84))))))
          (st_sig_methods ()) (st_sig_base_id 86) (st_sig_id 88)))))
      (union_signs (0 ())))) |}]
     ...
     ((bindings
       ((b
         (Value
          (UnionVariant
           ((Struct
             ((Value (Type (StructType 84))) ((value (Value (Integer 1))))))
            87))))
        (a (Value (UnionVariant ((Integer 10) 87))))
        (test
         (Value
          (Function
           ((function_signature
             ((function_params ((value (UnionType 87))))
              (function_returns (UnionType 87))))
            (function_impl (Fn (Return (Reference (value (UnionType 87))))))))))
        (Uni (Value (Type (UnionType 87))))))
      (structs
       ((85
         ((struct_fields
           ((slice ((field_type (StructType 6))))
      ...
      (unions
       ((87
         ((cases
           (((StructType 84) (Discriminator 1)) (IntegerType (Discriminator 0))))
          (union_details
           ((uty_methods ())
            (uty_impls
             (((impl_interface 10)
      ...
      (union_signs
       (1
        (((un_sig_cases (IntegerType (StructType 84))) (un_sig_methods ())
          (un_sig_base_id 86))))))) |}]
...
let%expect_test "unions" =
  ...
  [%expect
    {|
    (Ok
     ((bindings ((Test (Value (Type (UnionType 89))))))
      (structs
       ((87
         ((struct_fields
           ((slice ((field_type (StructType 6))))
      ...
      (unions
       ((89
         ((cases
           (((StructType 86) (Discriminator 1))
            ((StructType 84) (Discriminator 0))))
          (union_details
           ((uty_methods
             ((id
               ((function_signature
                 ((function_params ((self (UnionType 89))))
                  (function_returns (UnionType 89))))
                (function_impl (Fn (Return (Reference (self (UnionType 89))))))))))
            (uty_impls
             (((impl_interface 90)
               (impl_methods
                ((from
                  ((function_signature
                    ((function_params ((v (StructType 84))))
                     (function_returns (UnionType 88))))
                   (function_impl
                    (Fn
                     (Return
                      (MakeUnionVariant ((Reference (v (StructType 84))) 89))))))))))
              ((impl_interface 91)
               (impl_methods
                ((from
                  ((function_signature
                    ((function_params ((v (StructType 86))))
                     (function_returns (UnionType 88))))
                   (function_impl
                    (Fn
                     (Return
                      (MakeUnionVariant ((Reference (v (StructType 86))) 89))))))))))))
            (uty_id 89) (uty_base_id 88)))))))
      (interfaces
       ((91
         ((interface_methods
           ((from
      ...
      (union_signs
       (1
        (((un_sig_cases ((StructType 84) (StructType 86))) (un_sig_methods ())
          (un_sig_base_id 88))))))) |}]
  ...
  [%expect
    ...
    (Ok
     ((bindings
      ...
      (struct_signs
       (2
        (((st_sig_fields ()) (st_sig_methods ()) (st_sig_base_id 86)
          (st_sig_id 89))
         ((st_sig_fields ())
          (st_sig_methods
           ((id
       ...
       ((must_be_64 (Value (Integer 64))) (must_be_32 (Value (Integer 32)))
        (test
         (Value
          (Function
           ((function_signature
             ((function_params ((i (UnionType 89))))
              (function_returns IntegerType)))
            (function_impl
             (Fn
              (Break
               (Switch
                ((switch_condition (Reference (i (UnionType 89))))
                 (branches
                  (((branch_ty (StructType 84)) (branch_var vax)
                    (branch_stmt (Block ((Return (Value (Integer 32)))))))
                   ((branch_ty (StructType 86)) (branch_var vax)
                    (branch_stmt (Block ((Return (Value (Integer 64))))))))))))))))))
        (Ints (Value (Type (UnionType 89))))))
      (structs
       ((87
         ((struct_fields
           ((slice ((field_type (StructType 6))))
  ...
  [%expect
    ...
    (Ok
     ((bindings
       ((a
         (Value
          (Struct ((Value (Type (StructType 86))) ((value (Value (Integer 2))))))))
        (a
         (Value
          (Struct ((Value (Type (StructType 84))) ((value (Value (Integer 1))))))))))
      (structs
  ...
  [%expect
    ...
    (((TypeError ((InterfaceType 84) (TypeN 0))))
     ((bindings
      ...
      (struct_signs
       (1
        (((st_sig_fields ()) (st_sig_methods ()) (st_sig_base_id 85)
          (st_sig_id 88)))))
      (union_signs (0 ())))) |}]
